...
insert  into `wm_article_author`(`author_id`,`author_type`,`author_name`,`author_default`,`author_data`) values (1,'s','ต้นฉบับ',1,9),(32,'a','admin',1,9),(65,'e','admin',0,9);
...
CREATE TABLE `wm_author_author` (
  ...
  `author_nickname` varchar(30) NOT NULL COMMENT '作者笔名，不允许更改',
...
insert  into `wm_manager_manager`(`manager_id`,`manager_status`,`manager_cid`,`manager_name`,`manager_psw`,`manager_salt`,`manager_lastip`,`manager_lasttime`) values (1,1,0,'admin','d4b6232e4aa20cd032009cbb79b3452507a24830','a8e52ffc28e3300ee098aec5b1415b6cea5befcb','127.0.0.1',1569121342),(4,1,1,'sdasd','b8dbfcaea467bc655229df4a370cabe063f7daa4',NULL,'127.0.0.1',1499091969);
...
CREATE TABLE `wm_novel_volume` (
  ...
  `volume_desc` varchar(200) DEFAULT NULL COMMENT '分卷描述',
...
CREATE TABLE `wm_seo_html` (
  ...
  PRIMARY KEY (`html_id`)
) ENGINE=MyISAM AUTO_INCREMENT=156 DEFAULT CHARSET=utf8 COMMENT='分类和内容静态地址表';
