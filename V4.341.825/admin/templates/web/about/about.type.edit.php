            	...
            	<div class="tab-pane fade active in" id="<?php echo $cFun.$type;?>base">
					<table class="table table-border table-bordered table-bg table-sort">
					    ...
					    <tr>
					      ...
					      <td valign="top"><input data-rule="ชื่อหมวดหมู่:required;" name="type[type_name]" type="text" class="input-text" value="<?php echo C('type_name',null,'data');?>"></td>
						</tr>
					    <tr>
					...
					<table class="table table-border table-bordered table-bg table-sort">
					    <tr>
					      ...
					      <td valign="top">
					      	...
					      	<input id="temp_name" name="temp[temp_name]" type="text" value="<?php echo C('name',null,'temp');?>" data-toggle="lookup" data-url="index.php?c=system.templates.lookup&module=about&page=list&name=name&tid=tempid" data-title="เลือกเทมเพลตที่จะใช้กับหน้านี้" size="15" data-width="700" data-height="500">
					      	<a class="btn btn-default" href="index.php?c=system.templates.edit&t=add&module=about&page=list&name=name&tid=tempid" data-toggle="dialog" data-title="อัปโหลดเทมเพลตใหม่" data-width="540" data-height="450" ><i class="fa fa-cloud-upload">&nbsp;</i>อัปโหลดเทมเพลต</a>
					      </td>
						</tr>
					    <tr>
					      ...
					      <td valign="top">
					      	...
					      	<input id="temp_cname" name="temp[temp_cname]" type="text" value="<?php echo C('cname',null,'temp');?>" data-toggle="lookup" data-url="index.php?c=system.templates.lookup&module=about&page=content&name=cname&tid=ctempid" data-title="เลือกเทมเพลตที่จะใช้กับหน้านี้" size="15" data-width="700" data-height="500">
					      	<a class="btn btn-default" href="index.php?c=system.templates.edit&t=add&module=about&page=content&name=cname&tid=ctempid" data-toggle="dialog" data-title="อัปโหลดเทมเพลตใหม่" data-width="540" data-height="450" ><i class="fa fa-cloud-upload">&nbsp;</i>อัปโหลดเทมเพลต</a>
					      </td>
						</tr>
					    <tr>
