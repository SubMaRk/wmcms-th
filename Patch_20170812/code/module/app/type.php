...
//获得页面的标题等信息
$data = app::GetData( 'type' , $where , $lang['system']['type']['no'] );
...
C('page' ,  array(
	...
	'ot'=>$ot,
	'page'=>$page,
	'listurl'=>tpl::url('app_type',array('cid'=>$cid,'lid'=>$lid,'cid'=>$cid,'pid'=>$pid,'ot'=>$ot,'page'=>'{page}','tid'=>$tid,'tpinyin'=>$data[0]['type_pinyin'],)),
));
