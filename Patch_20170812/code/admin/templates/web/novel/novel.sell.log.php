            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                    	<h3 class="panel-title"><i class="fa fa-bar-chart-o fa-fw"></i>《<?php echo $data['novel_name'];?>》基本销售数据统计【签约等级：<b style="color:red">白金签约</b>，分成比例：<b style="color:red">10%</b>】</h3>
                    </div>
                    <div class="panel-body" style="font-size: 18px">
					     ...
					     <tr>
					        ...
					        <td width="180" class="titleTd">销售分成</td>
					      	<td width="100" class="titleTd">盈利统计</td>
					      </tr>
					     <tr style="height:40px">
					        <td class="titleTd">今日</td>
					        <td><?php echo $data['today']['sub']?><br/>
					        	<?php
					        	if($data['today']['sub']-$data['yesterday']['sub']>0)
					        	{
					        		echo '<span class="up">↑+'.str::GetPer($data['today']['sub'],$data['yesterday']['sub']).'%</span>';
					        	}
					        	else if($data['today']['money']==$data['yesterday']['sub'])
					        	{
					        		echo '<span class="eq">=0.00%</span>';
					        	}
					        	else
					        	{
					        		echo '<span class="down">↓'.str::GetPer($data['today']['sub'],$data['yesterday']['sub']).'%</span>';
					        	}
					        	?>
					        </td>
