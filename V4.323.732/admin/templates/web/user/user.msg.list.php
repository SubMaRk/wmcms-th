				...
				foreach ($dataArr as $k=>$v)
				{
					...
					echo '<tr class="'.$cur.'">
							...
							<td style="text-align: center;" data-noedit="true">
				            	<a class="btn btn-secondary radius size-MINI" data-toggle="navtab" data-id="user-user-edit" data-title="编辑用户内容" href="index.php?d=yes&c=user.msg.detail&id='.$v['msg_id'].'">详细</a> 
