					...
					<table class="table table-border table-bordered table-bg table-sort">
		                ...
		                <tr>
		                    ...
		                    <td valign="top" colspan="3">
					      		<select data-toggle="selectpicker" name="autoreply[autoreply_type]">
		                        <?php 
		                ...
		                <tr class="autoreply_content_box" id="<?php echo $cFun;?>textBox">
		                    <td><b>回复内容：</b></td>
		                    <td valign="top" colspan="3">
		                ...
		                <tr class="autoreply_content_box" id="<?php echo $cFun;?>imageBox">
		                    <td><b>素材ID：</b></td>
		                    <td valign="top" colspan="3">
		                    	<input type="text" size="30" data-toggle="lookup" data-url="index.php?c=operate.weixin.media.lookup&st=a&aid=<?php echo $aid;?>" data-width="820" data-title="选择素材" name="autoreply[autoreply_media_id]"  value="<?php echo C('autoreply_media_id',null,'data');?>">
						    </td>
		                </tr>
		            </tbody>
		        </table>
...
$(function(){
	$('#<?php echo $cFun.C('autoreply_type',null,'data');?>Box').show();
	
	$('[name=autoreply\\[autoreply_type\\]]').change(function(){
		$('.autoreply_content_box').hide();
		$('#<?php echo $cFun;?>'+$(this).val()+'Box').show();
	})
	
	//查找回调
	$(':input').on('afterchange.bjui.lookup', function(e, data) {
		$('[name=autoreply\\[autoreply_media_id\\]').val(data.value);
	})
})
</script>