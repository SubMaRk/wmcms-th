		...
		<table class="table table-border table-bordered table-hover table-bg table-sort">
			...
			if( $dataArr )
			{
				...
				foreach ($dataArr as $k=>$v)
				{
					...
					$status = str::CheckElse( $v['autoreply_status'] , 0 , '<a href="javascript:;" onClick="'.$cFun.'Ajax(1,'.$v['autoreply_id'].')"><span style="color:red">未审核</span></a>' , '<a href="javascript:;" onClick="'.$cFun.'Ajax(0,'.$v['autoreply_id'].')"><span style="color:green">已审核</span></a>');
