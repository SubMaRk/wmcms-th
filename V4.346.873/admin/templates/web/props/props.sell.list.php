...
<div class="bjui-pageContent">
		<table class="table table-border table-bordered table-hover table-bg table-sort">
			<thead>
				...
				<th width="20%" data-order-field="props_user_id">购买用户</th>
				<th width="20%" data-order-field="props_user_cid">赠送小说</th>
				<th width="8%" data-order-field="sell_number">销售数量</th>
				<th width="8%" data-order-field="sell_gold1"><?php echo $config['gold1_name']?></th>
	            <th width="8%" data-order-field="sell_gold2"><?php echo $config['gold2_name']?></th>
	            <th width="8%" data-order-field="sell_money">人民币</th>
			...
			if( $dataArr )
			{
				...
				foreach ($dataArr as $k=>$v)
				{
					...
					echo '<tr class="'.$cur.'">
							...
							<td style="text-align: center;">'.$v['props_name'].'</td>
