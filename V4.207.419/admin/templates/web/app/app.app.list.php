...
<div class="bjui-pageContent">
		<table class="table table-border table-bordered table-hover table-bg table-sort">
			<thead>
	            ...
	            <th width="5%" data-order-field="app_aid">开发商</th>
	            <th width="5%" data-order-field="app_lid">语言</th>
	            <th width="5%" data-order-field="app_cid">资费</th>
	            <th width="5%" data-order-field="app_downnum">下载量</th>
			...
			if( $dataArr )
			{
				...
				foreach ($dataArr as $k=>$v)
				{
					...
					echo '<tr class="'.$cur.'">
							...
							<td style="text-align: center;">'.$v['attr_lname'].'</td>
							<td style="text-align: center;">'.$v['attr_cname'].'</td>
							<td style="text-align: center;">'.$v['app_downnum'].'</td>
