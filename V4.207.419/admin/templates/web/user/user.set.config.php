...
<div class="bjui-pageContent">
    ...
    <table class="table table-border table-bordered table-hover table-bg table-sort <?php echo $cFun?>Table">
      ...
      <tr>
        <td width="200">ตรวจอักษรที่สงวนไว้</td>
        <td><?php echo $manager->GetForm('user' , 'check_shield');?></td>
        <td>ตรวจสอบอักษรที่ห้ามใช้ : </td>
        <td colspan="3"><?php echo $manager->GetForm('user' , 'check_disable');?></td>
      </tr>
      <tr>
