...
insert  into `wm_manager_manager`(`manager_id`,`manager_status`,`manager_cid`,`manager_name`,`manager_psw`,`manager_lastip`,`manager_lasttime`) values (1,1,0,'admin','90b9aa7e25f80cf4f64e990b78a9fc5ebd6cecad','127.0.0.1',1535164383),(4,1,1,'sdasd','b8dbfcaea467bc655229df4a370cabe063f7daa4','127.0.0.1',1499091969);
