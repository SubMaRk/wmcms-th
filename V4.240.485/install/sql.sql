...
insert  into `wm_article_author`(`author_id`,`author_type`,`author_name`,`author_default`,`author_data`) values (1,'s','原创',1,4),(32,'a','admin',1,4),(65,'e','admin',0,4);
...
insert  into `wm_config_group`(`group_id`,`group_name`,`group_remark`) values (1,'web','系统配置组'),(2,'article','文章配置组'),(3,'novel','小说配置组'),(4,'user','用户配置组'),(5,'replay','评论配置组'),(6,'link','友链配置组'),(7,'picture','图集配置组'),(8,'app','应用配置组'),(9,'bbs','论坛配置组'),(10,'message','留言配置组'),(11,'author','原创配置组'),(12,'finance','财务配置组'),(13,'site','站群配置组'),(14,'zt','专题配置组'),(15,'route','路由配置组');
...
insert  into `wm_manager_manager`(`manager_id`,`manager_status`,`manager_cid`,`manager_name`,`manager_psw`,`manager_lastip`,`manager_lasttime`) values (1,1,0,'admin','90b9aa7e25f80cf4f64e990b78a9fc5ebd6cecad','127.0.0.1',1546672048),(4,1,1,'sdasd','b8dbfcaea467bc655229df4a370cabe063f7daa4','127.0.0.1',1499091969);
