					...
					switch ($v['apply_status'])
					{
						case '0':
							...
							$set = '<button type="button" class="btn btn-warning radius" data-toggle="dropdown">操作<span class="caret"></span></button><ul class="dropdown-menu" style="width:90px"><li><a href="javascript:;" onClick="'.$cFun.'StatusAjax(1,'.$v['apply_id'].')">通过审核</a></li>
								  <li><a href="index.php?d=yes&c=system.apply.refuse&t=refuse_author_article_edit&id='.$v['apply_id'].'&module=author&type=article_editarticle&uid='.$v['apply_uid'].'&cid='.$v['apply_cid'].'" data-mask="true" data-toggle="dialog" data-title="拒绝章节修改申请" data-width="630" data-height="510">拒绝通过</a></li></ul>';
							break;
						case '1':
