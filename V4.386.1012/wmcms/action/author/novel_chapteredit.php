...
$content = str::IsEmpty( Request('content') , $lang['author']['chapter_content_err'] );
...
else
{
	...
	else
	{
		...
		else
		{
			...
			//修改已拒绝为审核中
			$chapterMod->Update(array('chapter_status'=>0) , $cid);
		}
	}
}
...
ReturnData($lang['author']['operate']['novel_chapter_'.$type.'_'.$status]['success'] , $ajax , 200);
