                    ...
                    <div class="panel-body" style="font-size: 18px">
					     ...
					     <tr>
					      ...
					      <tr>
					        ...
					        <td width="250" class="titleTd">本月更新章节：<?php echo $updateChapterCount;?> 章<br/>本月更新字数：<?php echo $updateChapterNumber/10000;?> 万字</td>
					      ...
					      <tr>
					        ...
					        <td width="250" class="titleTd"><input size="7" <?php if($applyData && $applyData['apply_status'] != '2'){echo 'disabled';}?> name="bonus_gold2" type="text" class="input-text" placeholder="不扣奖金请填0" value="0"> <?php echo $goldName;?></td>
					      ...
					      <tr>
					        ...
					        <td class="titleTd" colspan="3" style="color:green"><?php echo '<b id="'.$cFun.'real">'.$real.'</b> '.$goldName;?></td>
					      </tr>
					    </table>
					</div>
                </div>
