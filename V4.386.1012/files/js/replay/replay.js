				...
				for(var o in lists){
					...
					if ( lists[o].hasOwnProperty('child') && lists[o].child.length > 0 ){
						...
						for(var j in lists[o].child){
							...
							childhtml += '<div style="margin-bottom: 5px;clear:both" id="wmcms_replay_replaybox_'+lists[o].child[j].replay_id+'">'+
								'<div style="float:left;"><img src="'+lists[o].child[j].user_head+'" width="40" height="40" style="border: #84a8c2 solid 2px;border-radius: 5px;margin-right: 5px;"></div>'+
						...
						if( parseInt(replayconfig.replay_replay_number) < parseInt(lists[o].replay_count) ){
							...
							console.log(lists[o].replay_count);
						}
						childhtml = '<div class="wmcms_replay_replaycontent" style="background-color: #ededed;padding:15px;border-radius: 5px;margin-bottom: 15px;padding-bottom: 10px;">'+childhtml+mooreHtml+'</div>';
					}
