...
) ENGINE=MyISAM AUTO_INCREMENT=23 DEFAULT CHARSET=utf8 COMMENT='全站API接口系统表';
...
CREATE TABLE `wm_api_type` (
  ...
  PRIMARY KEY (`type_id`)
) ENGINE=MyISAM AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COMMENT='api接口类型表';

/*Data for the table `wm_api_type` */

insert  into `wm_api_type`(`type_id`,`type_title`,`type_name`,`type_order`) values (1,'站内接口','system',1),(2,'网页登录接口','login',2),(3,'PC支付接口','pay',3),(4,'存储接口','oss',4),(5,'SEO接口','seo',5),(6,'移动支付接口','pay_wap',3),(7,'APP支付接口','pay_app',3),(8,'APP登录接口','login_app',3);
...
) ENGINE=MyISAM AUTO_INCREMENT=432 DEFAULT CHARSET=utf8 COMMENT='系统配置表';
...
) ENGINE=MyISAM AUTO_INCREMENT=391 DEFAULT CHARSET=utf8 COMMENT='系统配置选项';
...
insert  into `wm_manager_manager`(`manager_id`,`manager_status`,`manager_cid`,`manager_name`,`manager_psw`,`manager_salt`,`manager_lastip`,`manager_lasttime`) values (1,1,0,'admin','d4b6232e4aa20cd032009cbb79b3452507a24830','a8e52ffc28e3300ee098aec5b1415b6cea5befcb','127.0.0.1',1613876021),(4,1,1,'sdasd','b8dbfcaea467bc655229df4a370cabe063f7daa4',NULL,'127.0.0.1',1499091969);
...
CREATE TABLE `wm_user_login` (
  ...
  PRIMARY KEY (`login_id`)
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='用户登录记录表';

/*Data for the table `wm_user_login` */

insert  into `wm_user_login`(`login_id`,`user_id`,`login_time`,`login_type`,`login_status`,`login_remark`,`login_ip`,`login_ua`,`login_browser`) values (1,1,1613889751,1,2,'密码错误','127.0.0.1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/86.0.4240.193 Safari/537.36','chrome');
