	...
	function GetHtml( $v , $lv = '')
	{
		...
		echo '<dt class="cf">
			<div class="btn-toolbar opt-btn cf">
				<a href="index.php?d=yes&c=novel.type.edit&t=edit&id='.$v['type_id'].'" data-toggle="navtab" data-id="novel-type-edit" data-title="แก้ไขหมวดหมู่นิยาย"><span class="btn btn-secondary size-MINI radius">แก้ไข</span></a>
