...
if ( $type == 'edit' || $type == "add"  )
{
	...
	$data['chapter_number'] = str::StrLen(str::DelSymbol($post['content']));
	//条件
	...
	//小说大于一本，并且作者为空
	else if( count($novelList) > 1 && @$post['novel_author'] == '' )
	{
	...
	//更新小说的最新章节信息
	$novelMod->UpNewChapter($novelData , $where['chapter_id'],$data['chapter_name']);
	//创建HTML
