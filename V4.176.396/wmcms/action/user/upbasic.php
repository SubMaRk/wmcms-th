...
$nickname = str::IsEmpty( Post('nickname') , $lang['user']['nickname_no']);
...
$sign = str::IsEmpty( Post('sign') , $lang['user']['sign_no']);
...
if( $result )
{
	ReturnData( $lang['user']['operate']['upbasic']['success'] , $ajax , $result);
}
else
{
