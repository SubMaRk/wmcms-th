...
insert  into `wm_manager_manager`(`manager_id`,`manager_status`,`manager_cid`,`manager_name`,`manager_psw`,`manager_lastip`,`manager_lasttime`) values (1,1,0,'admin','90b9aa7e25f80cf4f64e990b78a9fc5ebd6cecad','127.0.0.1',1533955633),(4,1,1,'sdasd','b8dbfcaea467bc655229df4a370cabe063f7daa4','127.0.0.1',1499091969);
...
) ENGINE=MyISAM AUTO_INCREMENT=12 DEFAULT CHARSET=utf8 COMMENT='小说分卷表';

/*Data for the table `wm_novel_volume` */

insert  into `wm_novel_volume`(`volume_id`,`volume_name`,`volume_nid`,`volume_desc`,`volume_order`,`volume_time`) values (1,'正文',0,'正文内容',0,22),(8,'1231',1,NULL,1,1513498585),(7,'123',1,NULL,1,1513498577),(6,'123',0,NULL,1,1513498461),(9,'1231',3,NULL,1,1513498588),(10,'asdfsf',1,NULL,11,1513510701),(11,'asdfsf',3,NULL,11,1513510721);
