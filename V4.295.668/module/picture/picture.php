...
//获得页面的标题等信息
$data = picture::GetData( 'content' , $where , $lang['system']['content']['no'] );
...
C('page' ,  array(
	...
	'pid'=>$pid,
	'page'=>$page,
	'listurl'=>tpl::Url('picture_picture' , array('tid'=>$tid,'pid'=>$pid)),
));
tpl::GetSeo();
...
//设置当前页面的地址
$replayUrl = tpl::Url( 'picture_replay' , array( 'tid'=>C('page.data.type_id'),'aid'=>C('page.data.picture_id') ) );
new replay( 'picture' , C('page.data.picture_id') , $replayUrl );
