...
insert  into `wm_article_author`(`author_id`,`author_type`,`author_name`,`author_default`,`author_data`) values (1,'s','原创',1,9),(32,'a','admin',1,9),(65,'e','admin',0,9);
...
insert  into `wm_manager_manager`(`manager_id`,`manager_status`,`manager_cid`,`manager_name`,`manager_psw`,`manager_salt`,`manager_lastip`,`manager_lasttime`) values (1,1,0,'admin','90b9aa7e25f80cf4f64e990b78a9fc5ebd6cecad','','127.0.0.1',1556329444),(4,1,1,'sdasd','b8dbfcaea467bc655229df4a370cabe063f7daa4',NULL,'127.0.0.1',1499091969);
