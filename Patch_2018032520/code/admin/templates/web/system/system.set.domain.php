		    	...
		    	<div class="tab-pane fade" id="domain">   
			    	<table class="table table-border table-bordered table-bg table-sort">
				      	<tr>
	                		...
	                		<td width="10%">后台文件夹名</td>
			                <td>
			                	<input name="admin_path" value="<?php echo C('config.web.admin_path');?>" type="text" size="15"/>
			                </td>
	                		<td width="15%">开启域名认证<br/>
			                	开启后只能通过绑定的后台域名访问管理后台。
			                </td>
			                <td>
			                	<?php echo $manager->GetForm('domain','admin_domain_access');?>
			                </td>
						</tr>
						<tr>
			        		<td colspan="6"><span class="STYLE2"><b>以下模块域名不绑定请留空(域名无需加http://)</b></span></td>
						</tr>
						<?php
