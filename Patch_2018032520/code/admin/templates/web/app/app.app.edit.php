		            ...
		            <tbody>
		                ...
		                <tr>
		                    <td colspan="2">
		                        ...
		                        <select data-toggle="selectpicker" name="app[app_lid]">
			                        <?php 
								    foreach ($lAttrArr as $k=>$v)
								    {
								    	$checked = str::CheckElse( $v['attr_id'], C('app_lid',null,'data') , 'true');
								    	echo '<option value="'.$v['attr_id'].'" '.$checked.'>'.$v['attr_name'].'</option>';
								    }
								    ?>
                                </select>
		                        <b style="margin-left: 150px">应 用 资 费：</b>
		                        <select data-toggle="selectpicker" name="app[app_cid]">
			                        <?php 
								    foreach ($cAttrArr as $k=>$v)
								    {
								    	$checked = str::CheckElse( $v['attr_id'], C('app_cid',null,'data') , 'true');
								    	echo '<option value="'.$v['attr_id'].'" '.$checked.'>'.$v['attr_name'].'</option>';
								    }
								    ?>
                                </select>
		                ...
		                <tr>
		                   <td colspan="2">
		                        ...
		                        <select data-toggle="selectpicker" name="app[app_paid]">
			                        <?php 
								    foreach ($pAttrArr as $k=>$v)
								    {
								    	$checked = str::CheckElse( $v['attr_id'], C('app_paid',null,'data') , 'true');
								    	echo '<option value="'.$v['attr_id'].'" '.$checked.'>'.$v['attr_name'].'</option>';
								    }
								    ?>
                                </select>
		                ...
		                <tr>
		                   <td colspan="2">
		                        ...
		                        <div class="wm_form_content_box">
									<?php echo Ueditor('width: 90%;height:300px' , 'app[app_content]' , C('app_content',null,'data'));?>
		                        </div>
		                    </td>
		                </tr>
		            </tbody>
