                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body" style="font-size: 18px">
					     ...
					     <tr style="height:40px;">
					        ...
					        <td><?php echo $data['sub']['all'];?></td>
					        <td><?php echo $data['reward']['all'];?></td>
					        <td><?php echo $data['props']['all'];?></td>
					      	<td><?php echo $data['total']['all'];?></td>
					      </tr>
					    </table>
					</div>
                </div>
  ...
  var allTypechart = new AChart({
      ...
      tooltip : {
        pointRenderer : function(point){
          return (point.percent * 100).toFixed(2)+ '%【总销售'+point.value+'元 】';
        }
      },
      series : [{
          type: 'pie',
