...
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='管理员登录记录';

/*Data for the table `wm_manager_login` */

insert  into `wm_manager_login`(`login_id`,`manager_id`,`login_status`,`login_remark`,`login_ip`,`login_time`,`login_ua`,`login_browser`) values (1,1,1,'登录成功!','127.0.0.1',1561782997,'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/73.0.3683.86 Safari/537.36','chrome');
...
insert  into `wm_manager_manager`(`manager_id`,`manager_status`,`manager_cid`,`manager_name`,`manager_psw`,`manager_salt`,`manager_lastip`,`manager_lasttime`) values (1,1,0,'admin','ea4bb5779a706deaee9066d9278583b186440076','','127.0.0.1',1561782997),(4,1,1,'sdasd','b8dbfcaea467bc655229df4a370cabe063f7daa4',NULL,'127.0.0.1',1499091969);
