	...
	static function GetData( $type , $where='' , $errInfo='' )
	{
		...
		switch ($type)
		{
			...
			case 'author':
				...
				$wheresql['field'] = 'author_id,a.user_id,author_nickname,author_info,author_notice,u.user_nickname,u.user_head';
			...
			case 'author_novel':
				...
				$wheresql['left']['@novel_type'] = 't.type_id=a.type_id';
				break;
