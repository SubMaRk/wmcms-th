	...
	static function GetData( $type , $where='' , $errInfo='' )
	{
		...
		switch ($type)
		{
			...
			case 'rec':
				...
				$wheresql['field'] = 'n.*,r.rec_rt,rec_img3,rec_img4,type_name,type_cname';
			...
			//最新章节
			case 'chapter':
				$wheresql['field'] = 'chapter_ispay,chapter_id,chapter_nid,chapter_name,chapter_istxt,chapter_cid,chapter_time,chapter_path,left(content,500) as content';
